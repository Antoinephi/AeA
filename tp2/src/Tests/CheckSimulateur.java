...
public class CheckSimulateur {
	...
	/**
	 * Vérifie que le nombre d'appariements à la suite est toujours au moins de
	 * 3
	 * 
	 * @return
	 */
	...
	/**
	 * Vérifie que les boucles ne dépassent pas le quotas autorisé
	 * 
	 * @return
	 */
	public boolean nbInLoop() {
		...
		int j = i - 1;
		int nb = 0;
		/* Vérification de la boucle finale */
